  ...
  return (
    <motion.div variants={fadeIn("up", "spring", index * 0.5, 0.75)}>
      ...
      >
        ...
        <div className="mt-5">
          <h3 className="text-white font-bold text-[24px]">{name}</h3>
          <p className="mt-2 text-secondary text-[14px] h-[55px]">{description}</p>
        </div>
      ...
      <>
        ...
        <div className="w-full flex">
          <p>
            ...
            경험을 반영합니다. 각 프로젝트들에 대한 상세한 설명은 깃헙
            레포지토리 링크에 기재되어 있습니다.
            {/* 각 프로젝트들은 깃헙 레포지토리 및 라이브 데모에
  ...
  return (
    <>
      ...
      <div className="w-full flex">
        ...
        >
          아래 프로젝트들은 진행했던 제 작업들을 나열하여 그간 학습했던 기술과
          경험을 반영합니다. 각 프로젝트들에 대한 상세한 설명은 깃헙 레포지토리
          링크에 기재되어 있습니다.
          {/* 아래 프로젝트들은 진행했던 제 작업들을 나열하여 그간 학습했던 기술과
